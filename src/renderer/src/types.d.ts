...
interface IBinanceFuturesPositionRisk {
    symbol: string;
    positionAmt: string;
    entryPrice: string;
    markPrice: string;
...
interface Window {
    ...
    Binance: {
        init: (apiKey: string, apiSecret: string) => void,
        futuresAccount: () => Promise<IBinanceFuturesAccount>,
        futuresPrices: (symbol: string) => Promise<{ [symbol: string]: number }>,
        futuresMarkPrice: (symbol: string) => Promise<IBinanceFuturesMarkPrice>,
        futuresPositionRisk: (symbol: string) => Promise<IBinanceFuturesPositionRisk[]>,
        futuresUserTrades: (symbol: string) => Promise<IBinanceFuturesUserTrade[]>,
